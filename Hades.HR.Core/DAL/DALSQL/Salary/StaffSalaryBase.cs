...
namespace Hades.HR.DALSQL
{
    ...
    /// StaffSalaryBase
    /// </summary>
	public class StaffSalaryBase : BaseDALSQL<StaffSalaryBaseInfo>, IStaffSalaryBase
    {
        #region 对象实例及构造函数

        public static StaffSalaryBase Instance
        {
            get
            {
                return new StaffSalaryBase();
            }
        }
        public StaffSalaryBase() : base("HR_StaffSalaryBase", "Id")
        {
        }
        ...
        protected override StaffSalaryBaseInfo DataReaderToEntity(IDataReader dataReader)
        {
        ...
        protected override Hashtable GetHashByEntity(StaffSalaryBaseInfo obj)
        {
            StaffSalaryBaseInfo info = obj as StaffSalaryBaseInfo;
