...
{
    /// <summary>
    /// LaborProductionWorkloadInfo
    /// </summary>
    [DataContract]
    public class LaborProductionWorkloadInfo : BaseEntity
    {
        /// <summary>
        /// 默认构造函数（需要初始化属性的在此处理）
        /// </summary>
        public LaborProductionWorkloadInfo()
        {
        ...
        [DataMember]
        public virtual string CompleteId { get; set; }
