...
namespace Hades.HR.WinformCaller
{
	...
	/// </summary>
    public class CompletionListCaller : BaseLocalService<CompletionListInfo>, ICompletionListService
    {
        private CompletionList bll = null;

        public CompletionListCaller() : base(BLLFactory<CompletionList>.Instance)
        {
