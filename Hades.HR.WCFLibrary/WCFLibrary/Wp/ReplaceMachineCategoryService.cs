...
{
	/// <summary>
	/// 基于WCFLibrary的ReplaceMachineCategory对象调用类
	/// </summary>
    public class ReplaceMachineCategoryService : BaseLocalService<ReplaceMachineCategoryInfo>, IReplaceMachineCategoryService
    {
        private ReplaceMachineCategory bll = null;

        public ReplaceMachineCategoryService() : base(BLLFactory<ReplaceMachineCategory>.Instance)
        {
